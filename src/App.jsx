        ...
        <div className="relative mx-auto max-w-[1600px] px-4 py-7 sm:px-6 sm:py-10 lg:px-10 xl:px-12">
          ...
          <div className="grid items-center gap-7 lg:grid-cols-[1fr_auto]">
            ...
            <div>
              ...
              <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-3 py-1.5 text-[11px] font-extrabold uppercase tracking-wider text-blue-700">
                <span className="h-1.5 w-1.5 rounded-full bg-blue-600" />
                India's Local Job Marketplace
              </div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500 sm:text-base">
                Discover local jobs, choose your work category
                and apply quickly through JobHir.
              </p>
